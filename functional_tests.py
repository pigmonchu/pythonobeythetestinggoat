...
class NewVisitorTest(unittest.TestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        ...
        # She notices the page title and heade mention to-do lists
        ...
        # There is still a text box inviting her to add another item. She enters "Use peacock feather to make a fly. She is very methodical"
        ...
        # Safisfied, she goes back to sleep
